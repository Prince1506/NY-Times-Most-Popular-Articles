...
class NYTimesMostViewedArticlesRepo @Inject constructor(networkHelper: NetworkHelper) : IVideosRepo {
    ...
    override fun getNyTimesMostViewedArticles(day: Int?, apiKey: String): Observable<NYTimesMostPopularArticlesEntity?>? {
        return networkHelper.createRetrofitApi(BASE_URL, IVideosRepo::class.java)
